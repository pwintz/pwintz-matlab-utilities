function assertColumnIn(column, array, context, options)
  ...
  if ~pwintz.arrays.isColumnIn(column, array)
    ...
    message = pwintz.strings.format("Expected %s=%g to be a column in %s=%g.", column_name, column, array_name, array);
